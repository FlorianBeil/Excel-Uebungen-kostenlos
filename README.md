...
| `daten/aufgaben.json` | Die fünf Aufgaben, alle Texte und die Konfiguration (Webinar-, Kurs-, Impressum-, Datenschutz- und Seitenadresse) |
...
- **Auswertung Kostenlos Übersicht** – Besuche, Angebot gesehen, Klicks (Webinar, Kurs, Mail-Link) je Gerät
